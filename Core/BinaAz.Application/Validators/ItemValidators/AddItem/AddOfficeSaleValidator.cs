...
public class AddOfficeSaleValidator : AbstractValidator<AddOfficeSaleDto>
{
    public AddOfficeSaleValidator()
    {
        RuleFor(x => x.Email)
        ...
        RuleFor(x => x.TypeOfOffice)
            .NotEmpty()
            .WithMessage("Please specify the type of office");
    }
}