...
public class AddGardenHouseCommandHandler : IRequestHandler<AddGardenHouseCommandRequest, AddGardenHouseCommandResponse>
{
    ...
    public AddGardenHouseCommandHandler(IItemService itemService, ILocalStorageService localStorageService, IRepository<Image> imageRepository, IRepository<Domain.Entities.TPH.Base.Item> itemRepository, IHttpContextAccessor contextAccessor)
    {
