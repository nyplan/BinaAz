...
public class AddGroundCommandHandler : IRequestHandler<AddGroundCommandRequest, AddGroundCommandResponse>
{
    ...
    public AddGroundCommandHandler(IItemService itemService, ILocalStorageService localStorageService, IRepository<Domain.Entities.TPH.Base.Item> itemRepository, IHttpContextAccessor contextAccessor)
    {
