...
public class AddNewBuildingCommandHandler : IRequestHandler<AddNewBuildingCommandRequest, AddNewBuildingCommandResponse>
{
    ...
    public AddNewBuildingCommandHandler(IItemService itemService, ILocalStorageService localStorageService, IRepository<Domain.Entities.TPH.Base.Item> itemRepository, IHttpContextAccessor contextAccessor)
    {
