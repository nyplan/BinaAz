...
public class LikeAnItemCommandHandler : IRequestHandler<LikeAnItemCommandRequest, bool>
{
    private readonly IHttpContextAccessor _contextAccessor;
    private readonly IRepository<Domain.Entities.User> _userRepository;
    private readonly IRepository<Domain.Entities.TPH.Base.Item> _itemRepository;

    public LikeAnItemCommandHandler(IHttpContextAccessor contextAccessor, IRepository<Domain.Entities.User> userRepository, IRepository<Domain.Entities.TPH.Base.Item> itemRepository)
    {
    ...
    public async Task<bool> Handle(LikeAnItemCommandRequest request, CancellationToken cancellationToken)
    {
